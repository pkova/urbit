...
gulp.task('css-bundle', function() {
  ...
  return gulp
    ...
    .pipe(gulp.dest('../../arvo/app/books/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
    ...
    .pipe(gulp.dest('../../arvo/app/books/js/'))
    .on('end', cb);
});
...
gulp.task('js-minify', function () {
  return gulp.src('../../arvo/app/books/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('../../arvo/app/books/js/'));
});

gulp.task('tile-js-minify', function () {
  return gulp.src('../../arvo/app/books/js/tile.js')
    .pipe(minify())
    .pipe(gulp.dest('../../arvo/app/books/js/'));
});

gulp.task('rename-index-min', function() {
  return gulp.src('../../arvo/app/books/js/index-min.js')
    .pipe(rename('index.js'))
    .pipe(gulp.dest('../../arvo/app/books/js/'))
});

gulp.task('rename-tile-min', function() {
  return gulp.src('../../arvo/app/books/js/tile-min.js')
    .pipe(rename('tile.js'))
    .pipe(gulp.dest('../../arvo/app/books/js/'))});

gulp.task('clean-min', function() {
  return del(['../../arvo/app/books/js/index-min.js', '../../arvo/app/books/js/tile-min.js'], {force: true})
});
