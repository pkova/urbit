...
import { BooksUpdateReducer } from '/reducers/books-update';
import { LocalReducer } from '/reducers/local.js';
import { ImportUpdateReducer } from '/reducers/import-update';
...
class Store {
  constructor() {
    ...
    this.booksUpdateReducer = new BooksUpdateReducer();
    this.importUpdateReducer = new ImportUpdateReducer();
    this.setState = () => {};
  }
  ...
  handleEvent(data) {
    ...
    this.booksUpdateReducer.reduce(json, this.state);
    this.importUpdateReducer.reduce(json, this.state);
