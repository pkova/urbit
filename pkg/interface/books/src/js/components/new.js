  ...
  render() {
    ...
    return (
      <div
        ...
        <h2 className="mb3 f8">New Shelf</h2>
        <div className="w-100">
          ...
          <IconSpinner awaiting={this.state.disabled} classes="mt3" text="Creating shelf..." />
        </div>
      </div>
    );
  }
