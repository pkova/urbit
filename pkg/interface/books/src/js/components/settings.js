...
import { IconSpinner } from './lib/icons/icon-spinner';
import { BooksTabBar } from '/components/lib/books-tab-bar';
...
export class SettingsScreen extends Component {
  ...
  removeShelf() {
    ...
    api.removeShelf(props.resourcePath)
    .then(() => {
      this.setState({
        isLoading: false
      });
  ...
  deleteShelf() {
    ...
    api.deleteShelf(props.resourcePath)
    .then(() => {
      this.setState({
        isLoading: false
      });
  ...
  renderRemove() {
    ...
    return (
      <div className="w-100 fl mt3">
        <p className="f8 mt3 lh-copy db">Remove Shelf</p>
        <p className="f9 gray2 db mb4">
          Remove this shelf from your shelf list.
        </p>
        <a onClick={this.removeShelf.bind(this)}
  ...
  renderDelete() {
    ...
    if (!props.amOwner) {
      ...
      return (
        <div className="w-100 fl mt3">
          <p className="f8 mt3 lh-copy db">Delete Shelf</p>
          <p className="f9 gray2 db mb4">
            Delete this shelf, for you and all group members.
          </p>
          <a onClick={this.deleteShelf.bind(this)}
  ...
  renderMetadataSettings() {
    ...
    return(
      <div>
        ...
        <p className="f9 gray2 db mb4">Change the name of this shelf</p>
        ...
        style={{maxWidth: "29rem"}}>
          ...
          <p className="f9 gray2 db mb4">
            Change the description of this shelf
          </p>
          <div className="relative w-100 flex"
            style={{ maxWidth: "29rem" }}>
            <input
          ...
          <p className="f9 gray2 db mb4">Give this shelf a color when viewing group channels</p>
          <div className="relative w-100 flex"
  ...
  render() {
    ...
    return (
      <div className="h-100 w-100 overflow-x-hidden flex flex-column white-d">
        ...
        <div className="w-100 pl3 mt4 cf">
          <h2 className="f8 pb2">Shelf Settings</h2>
          {this.renderRemove()}
          {this.renderDelete()}
