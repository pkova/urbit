...
export const ChannelsSidebar = (props) => {
  ...
  [...props.listening].map((path) => {
    let groupPath = !!props.associations.books[path] ?
                    props.associations.books[path]["group-path"] : "";
                             ...
                             .map((each) => {
                               ...
                               return (
                                 <GroupItem
                                   ...
                                   linkMetadata={props.associations["books"]}
                                   channels={channels}
  ...
  let activeClasses = (props.active === "collections") ? " " : "dn-s ";
